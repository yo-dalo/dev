...
const Login = () => {
  return (
    <div className='w-screen px-30 py-20 gap-14 phone:flex-col flex justify-center items-center  phone:px-10 phone:h-fit  h-screen bg-whitew'>
      ...
      <div className='w-1/3 phone:w-full  px-7 py-6 border border-gray-200 rounded-xl  flex flex-col justify-start items-center bg-whitew h-full '>
        <div className='flex justify-center items-center'>
          <div className='w-7 h-7'><img src="img/logo/Sign-Up/Group.svg" alt="" /></div>
